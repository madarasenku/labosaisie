...
| `cahier-jaune.test.js` | Forme du cahier (jours ouvrés, colonnes, sous-totaux hebdomadaires, total du mois), sorties négatives et explication obligatoire, cloisonnement spectateur et agent |
