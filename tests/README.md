...
| `cahier-jaune.test.js` | Forme du cahier (jours ouvrés, colonnes, sous-totaux hebdomadaires, total du mois), détail nominatif et numéro d'ordre mensuel, correction et suppression d'une écriture, sorties négatives et explication obligatoire, cloisonnement spectateur et agent |
