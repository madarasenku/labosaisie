...
const CATALOGUE_EXAMENS = [
  ...
  { id:'ex_rai',   label:'RAI + Phénotypage érythrocytaire',  groupe:'🩸 Groupe sanguin', tab:'gs', prix:10000, section:'sec-gs-standalone' },
  // ── Bilan prénatal ──
  ...
  { id:'ex_vih',   label:'Sérologie VIH 1 & 2',              groupe:'💉 Immuno-Sérologie', tab:'sero', prix:0, section:'sec-sero' },
  { id:'ex_hbs',   label:'Ag HBs (Hépatite B)',              groupe:'💉 Immuno-Sérologie', tab:'sero', prix:7000, section:'sec-sero' },
  { id:'ex_hbsac', label:'Ac anti-HBs',                      groupe:'💉 Immuno-Sérologie', tab:'sero', prix:15000, section:'sec-sero' },
  { id:'ex_hbcac', label:'Ac anti-HBc totaux',               groupe:'💉 Immuno-Sérologie', tab:'sero', prix:7000, section:'sec-sero' },
  ...
  { id:'ex_psa',   label:'PSA total',                        groupe:'💉 Immuno-Sérologie', tab:'sero', prix:15000, section:'sec-sero' },
  // ── Biochimie ──
  { id:'ex_gly',   label:'Glycémie à jeun',                  groupe:'🧪 Biochimie', tab:'bio', prix:1500, section:'sec-bio-glucides-wrap' },
  ...
  { id:'ex_malb',  label:'Microalbuminurie',                  groupe:'🧪 Biochimie', tab:'bio', prix:15000, section:'sec-bio-rein-wrap' },
  ...
  { id:'ex_ggt',   label:'Gamma GT',                          groupe:'🧪 Biochimie', tab:'bio', prix:8000, section:'sec-bio-foie-wrap' },
  { id:'ex_pal',   label:'Phosphatases alcalines',            groupe:'🧪 Biochimie', tab:'bio', prix:8000, section:'sec-bio-foie-wrap' },
  { id:'ex_bili',  label:'Bilirubine totale & directe',       groupe:'🧪 Biochimie', tab:'bio', prix:6000, section:'sec-bio-foie-wrap' },
  { id:'ex_prot',  label:'Protéines totales',                 groupe:'🧪 Biochimie', tab:'bio', prix:8000, section:'sec-bio-foie-wrap' },
  { id:'ex_alb',   label:'Albumine',                          groupe:'🧪 Biochimie', tab:'bio', prix:5000, section:'sec-bio-foie-wrap' },
  { id:'ex_ldh',   label:'LDH',                              groupe:'🧪 Biochimie', tab:'bio', prix:7000, section:'sec-bio-foie-wrap' },
  { id:'ex_amy',   label:'Amylase',                           groupe:'🧪 Biochimie', tab:'bio', prix:7000, section:'sec-bio-foie-wrap' },
  { id:'ex_lip',   label:'Lipase',                            groupe:'🧪 Biochimie', tab:'bio', prix:7000, section:'sec-bio-foie-wrap' },
  ...
  { id:'ex_ldl',   label:'LDL-cholestérol',                   groupe:'🧪 Biochimie', tab:'bio', prix:3500, section:'sec-bio-lipides-wrap' },
  { id:'ex_iono',  label:'Ionogramme (Na, K, Cl)',            groupe:'🧪 Biochimie', tab:'bio', prix:6000, section:'sec-bio-iono-wrap' },
  { id:'ex_ca',    label:'Calcium',                           groupe:'🧪 Biochimie', tab:'bio', prix:3000, section:'sec-bio-iono-wrap' },
  { id:'ex_phos',  label:'Phosphore',                         groupe:'🧪 Biochimie', tab:'bio', prix:6000, section:'sec-bio-iono-wrap' },
  { id:'ex_mg',    label:'Magnésium',                         groupe:'🧪 Biochimie', tab:'bio', prix:3000, section:'sec-bio-iono-wrap' },
  { id:'ex_bic',   label:'Bicarbonates',                      groupe:'🧪 Biochimie', tab:'bio', prix:10000, section:'sec-bio-iono-wrap' },
  { id:'ex_zinc',  label:'Zinc',                              groupe:'🧪 Biochimie', tab:'bio', prix:10000, section:'sec-bio-iono-wrap' },
  ...
  { id:'ex_ckmb',  label:'CK-MB',                            groupe:'🧪 Biochimie', tab:'bio', prix:25000, section:'sec-bio-card-wrap' },
  { id:'ex_myog',  label:'Myoglobine',                        groupe:'🧪 Biochimie', tab:'bio', prix:25000, section:'sec-bio-card-wrap' },
  { id:'ex_cort',  label:'Cortisol',                          groupe:'🧪 Biochimie', tab:'bio', prix:25000, section:'sec-bio-horm-wrap' },
  { id:'ex_acth',  label:'ACTH',                              groupe:'🧪 Biochimie', tab:'bio', prix:15000, section:'sec-bio-horm-wrap' },
  { id:'ex_lh',    label:'LH',                                groupe:'🧪 Biochimie', tab:'bio', prix:15000, section:'sec-bio-horm-wrap' },
  { id:'ex_fsh',   label:'FSH',                               groupe:'🧪 Biochimie', tab:'bio', prix:15000, section:'sec-bio-horm-wrap' },
  { id:'ex_e2',    label:'Estradiol (E2)',                    groupe:'🧪 Biochimie', tab:'bio', prix:15000, section:'sec-bio-horm-wrap' },
  { id:'ex_prog',  label:'Progestérone',                      groupe:'🧪 Biochimie', tab:'bio', prix:15000, section:'sec-bio-horm-wrap' },
  { id:'ex_test',  label:'Testostérone',                      groupe:'🧪 Biochimie', tab:'bio', prix:15000, section:'sec-bio-horm-wrap' },
  { id:'ex_prl',   label:'Prolactine',                        groupe:'🧪 Biochimie', tab:'bio', prix:15000, section:'sec-bio-horm-wrap' },
  { id:'ex_amh',   label:'AMH',                               groupe:'🧪 Biochimie', tab:'bio', prix:15000, section:'sec-bio-horm-wrap' },
  { id:'ex_vitd',  label:'Vitamine D (25-OH)',                groupe:'🧪 Biochimie', tab:'bio', prix:25000, section:'sec-bio-horm-wrap' },
  { id:'ex_b12',   label:'Vitamine B12',                      groupe:'🧪 Biochimie', tab:'bio', prix:25000, section:'sec-bio-horm-wrap' },
  { id:'ex_fol',   label:'Folates (B9)',                      groupe:'🧪 Biochimie', tab:'bio', prix:25000, section:'sec-bio-horm-wrap' },
  { id:'ex_pth',   label:'PTH (parathormone)',                groupe:'🧪 Biochimie', tab:'bio', prix:15000, section:'sec-bio-horm-wrap' },
  { id:'ex_pct',   label:'Procalcitonine (PCT)',              groupe:'🧪 Biochimie', tab:'bio', prix:25000, section:'sec-bio-autre-wrap' },
  { id:'ex_bhcg',  label:'Beta-HCG',                         groupe:'🧪 Biochimie', tab:'bio', prix:15000, section:'sec-bio-autre-wrap' },
  // ── Bactériologie ──
